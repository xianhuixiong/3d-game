...
import { EffectComposer, RenderPass, EffectPass, BloomEffect, SMAAEffect, ToneMappingEffect, VignetteEffect, OutlineEffect, SSAOEffect, Effect } from 'postprocessing'
